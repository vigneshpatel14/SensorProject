...
class DataTransformationConfig:
    ...
    #Ante ah artifacts ante data oka path ni store chesukuntunadu in the name of train with extension numpy
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            imputer_step = ("imputer" , SimpleImputer(stragery = 'constant' , fill_value = 0))
    ...
    def initiate_data_transformation(self):
        ...
        try:
            ...
            #Ante -1 unte 0 or 1 ayte alane undani
